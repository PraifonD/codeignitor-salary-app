...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo site_url('employee'); ?>">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo site_url('employee/profile'); ?>">
                    <i class="fas fa-fw fa-user"></i>
                    <span>ข้อมูลของฉัน</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?php echo site_url('employee/password'); ?>">
            ...
            <hr class="sidebar-divider">
            <!-- Heading -->
            <div class="sidebar-heading">บัญชีเงินเดือน</div>
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo site_url('employee/employee_payroll_list'); ?>">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?= $userData['employee_username']; ?></span>
                            ...
                            <div class="dropdown-menu-end dropdown-menu shadow animated--grow-in" aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="<?php echo site_url('employee/password'); ?>">
