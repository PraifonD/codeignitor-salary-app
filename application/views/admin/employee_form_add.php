    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form role="form" action="<?= site_url('admin/adding_employee'); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                        <div class="box-body">
                            <div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-12">
                                        <input type="text" name="employee_username" class="form-control" placeholder="Username" value="<?= set_value('employee_username'); ?>">
                                        <span class="fr"><?= form_error('employee_username'); ?></span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-12 col-md-6 mb-3 mb-md-1">
                                        <label class="col">รหัสผ่าน</label>
                                        <div class="col-sm-12">
                                            <input type="password" name="employee_password" class="form-control" placeholder="กรุณากรอกรหัสผ่าน" value="<?= set_value('employee_password'); ?>">
                                            <span class="fr"><?= form_error('employee_password'); ?></span>
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 mb-3 mb-md-1">
                                        <label class="col">ยืนยันรหัสผ่าน</label>
                                        <div class="col-sm-12">
                                            <input type="password" name="password_conf" class="form-control" placeholder="กรุณายืนยันรหัสผ่าน" value="<?= set_value('password_conf'); ?>">
                                            <span class="fr"><?= form_error('password_conf'); ?></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="form-group row">
                                    <div class="col-12 col-md-6 mb-3 mb-md-1">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" name="employee_name" class="form-control" placeholder="กรุณากรอก ชื่อ-นามสกุล" value="<?= set_value('employee_name'); ?>">
                                    ...
                                    <div class="col-12 col-md-6 mb-3 mb-md-1">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" name="employee_citizen_id" class="form-control" placeholder="กรุณากรอก เลขบัตรประชาชน" value="<?= set_value('employee_citizen_id'); ?>">
                                ...
                                <div class="form-group row">
                                    <div class="col-12 col-md-6 mb-3 mb-md-1">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="date" name="employee_birthdate" class="form-control" value="<?= set_value('employee_birthdate'); ?>">
                                    ...
                                    <div class="col-12 col-md-6 mb-3 mb-md-1">
                                        ...
                                        <div class="col-sm-12">
                                            <select name="employee_marital" class="form-control">
                                                <option value=" " hidden>กรุณาเลือกสถานภาพสมรส</option>
                            ...
                            <div>
                                ...
                                <div class="form-group row">
                                    <div class="col-12 col-md-6 mb-3 mb-md-1">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" name="employee_phone" class="form-control" placeholder="กรุณากรอกเบอร์โทร" value="<?= set_value('employee_phone'); ?>">
                                    ...
                                    <div class="col-12 col-md-6 mb-3 mb-md-1">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" name="employee_email" class="form-control" placeholder="กรุณากรอก อีเมลล์" value="<?= set_value('employee_email'); ?>">
                            ...
                            <div>
                                    ...
                                    <div class="col-12 col-md-6 mb-3 mb-md-1">
                                        ...
                                        <div class="col-sm-12">
                                            <select name="employee_employtype" class="form-control">
                                                <option value=" " hidden>กรุณาเลือกลักษณะการจ้างงาน</option>
                                ...
                                <div class="form-group row">
                                    <div class="col-12 col-md-6 mb-3 mb-md-1">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" name="salary_basesalary" class="form-control" placeholder="กรุณากรอกเงินเดือน (บาท)" value="<?= set_value('salary_basesalary'); ?>">
