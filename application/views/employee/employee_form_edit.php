...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">แก้ไขข้อมูลของฉัน</h1>
        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">ฟอร์มแก้ไขข้อมูลของฉัน</h6>
                </div>
                <div class="card-body">
                    <form role="form" action="<?= site_url('employee/editing_profile'); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                        <div class="box-body">
                            <div>

                                <div class="d-sm-flex align-items-center justify-content-left mb-4">
                                    <h6 class="text-primary"> ข้อมูล Account
                                        <a href="<?php echo  site_url('employee/password'); ?>" class="btn btn-primary btn-icon-split ml-2">
                                            <span class="text">แก้รหัสผ่าน</span>
                                        </a>
                                    </h6>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <textarea rows="4 " type="text" name="employee_address" class="form-control" placeholder="กรุณากรอกที่อยู่"><?php echo set_value('employee_address'); ?><?= $employee->employee_address; ?></textarea>
                            ...
                            <div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <a class="btn btn-danger" href="<?php echo  site_url('employee/profile'); ?>" role="button"><i class="fas fa-circle-xmark"></i> ยกเลิก</a>
                                    </div>
                                </div>
                            </div><!-- /.box-body -->
                    </form>
                ...
                <div class="card-footer mt-4">
                    <p class="fr">*หากต้องการแก้ไขข้อมูลส่วนที่จำกัดสิทธิ์ไว้ กรุณาติดต่อแอดมิน</p>
                </div>
            </div>
